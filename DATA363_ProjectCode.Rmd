...
```{r}
races[races$Year == 2024 & (races$Type == 'One-Day' | races$Race == 'Tour of Guangxi'), 'Total Distance - WOMEN']
as.numeric(races$`Final Winner Time - MEN`) # convert all times to seconds automatically
```
...
womenDistance2024Stage <- races[races$Year == 2024 & races$Type == 'Stage', 'Total Distance - WOMEN']
womenDistance2024GrandTour <- races[races$Year == 2024 & races$Type == 'Grand Tour', 'Total Distance - WOMEN']
womenDistance2024OneDay <- races[races$Year == 2024 & (races$Type == 'One-Day' | races$Race == 'Tour of Guangxi'), 'Total Distance - WOMEN']
